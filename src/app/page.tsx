    ...
    <div className="min-h-screen">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-orange-100">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <Link href="/" className="text-xl font-bold bg-gradient-to-r from-orange-500 to-amber-500 bg-clip-text text-transparent">
            네이밍 마스터
          </Link>
          <Link
            href="/generate"
            className="px-5 py-2 bg-gradient-to-r from-orange-500 to-amber-500 text-white rounded-full text-sm font-medium hover:shadow-lg hover:shadow-orange-200 transition-all duration-300"
          >
            무료로 시작하기
          </Link>
        </div>
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/generate"
              className="px-8 py-4 bg-gradient-to-r from-orange-500 to-amber-500 text-white rounded-2xl text-lg font-semibold hover:shadow-xl hover:shadow-orange-200 transition-all duration-300 hover:-translate-y-0.5"
            >
              상품명 만들기 →
            </Link>
            <a
              href="#features"
              className="px-8 py-4 bg-white border-2 border-orange-200 text-orange-600 rounded-2xl text-lg font-semibold hover:bg-orange-50 transition-all duration-300"
            >
              자세히 알아보기
            </a>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {STEPS.map((item) => (
              <div key={item.step} className="text-center">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-orange-500 to-amber-500 text-white text-2xl font-bold flex items-center justify-center mx-auto mb-4">
                  {item.step}
                </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {FEATURES.map((feature, i) => (
              <div
                key={i}
                className="p-6 bg-white rounded-2xl border border-orange-100 hover:shadow-lg hover:shadow-orange-50 transition-all duration-300"
              >
      ...
      <section className="py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-gradient-to-br from-orange-500 to-amber-500 rounded-3xl p-10 md:p-16 text-white">
            ...
            <Link
              href="/generate"
              className="inline-block px-8 py-4 bg-white text-orange-600 rounded-2xl text-lg font-semibold hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5"
            >
              무료로 상품명 만들기 →
            </Link>
          </div>
